  ...
  <div class="ep">
    ...
    <div class="ep-b">
      ...
      <table>
        ...
        <?php
        $fields = [
          ['invoice_kind','string',1,'Invoice kind: B2B or B2C.'],
          ...
          ['invoice_type_code','string',1,'FIRS invoice type code - see table above (e.g. 381 = Commercial Invoice).'],
          ...
          ['note','string',0,'Free-text note (encrypted at rest) - optional.'],
          ['tax_point_date','string',0,'Tax point date (YYYY-MM-DD) - optional.'],
          ['accounting_cost','string',0,'Buyer accounting cost / cost centre - optional.'],
          ['buyer_reference','string',0,'Buyer internal reference - optional.'],
          ['order_reference','string',0,'Purchase order reference - optional.'],
          ['invoice_delivery_period','object',0,'{ start_date, end_date } - optional.'],
          ['actual_delivery_date','string',0,'Actual delivery date (YYYY-MM-DD) - optional.'],
...
<pre><?php echo hljson('{
  ...
  "accounting_supplier_party": {
    ...
    "business_description": "General trade and services",
  ...
  "tax_total": [
    {
      "tax_amount": 6750,
      "tax_subtotal": [
        { "taxable_amount": 90000, "tax_amount": 6750, "tax_category": { "id": "STANDARD_VAT", "percent": 7.5 } }
      ]
    }
  ],
  "legal_monetary_total": {
    "line_extension_amount": 90000,
    "tax_exclusive_amount": 90000,
    "tax_inclusive_amount": 96750,
  ...
  "invoice_line": [
    {
      ...
      "discount_rate": 0, "discount_amount": 0, "fee_rate": 0, "fee_amount": 0,
